...
declare -x OLDPWD
declare -x PATH="/home/pi/Lepmon_env/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/games:/usr/games"
...
declare -x USER="Ento"
declare -x VIRTUAL_ENV="/home/pi/Lepmon_env"
declare -x VIRTUAL_ENV_PROMPT="(Lepmon_env) "
declare -x VTE_VERSION="7006"
declare -x WAYFIRE_CONFIG_FILE="/home/pi/.config/wayfire.ini"
...
#/usr/bin/python3 ~/Lepmon_skript/LED_002.py
#/usr/bin/python3 ~/Lepmon_skript/Lepmon.py
#/usr/bin/python3 ~/Lepmon_skript/LED_003.py
