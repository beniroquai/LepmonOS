...
def set_coordinates():
    ...
    write_value_to_section(get_config_path("Lepmon_config.json"), "GPS", "Pol",nordsued)     
    write_value_to_section(get_config_path("Lepmon_config.json"), "GPS", "Block",eastwest) 
...
# Prüfen, ob sich die Koordinaten geändert haben
    if latitude_write != latitude_read or longitude_write != longitude_read:
        ...
        write_value_to_section(get_config_path("Lepmon_config.json"), "GPS", "latitude", latitude_write)     
        write_value_to_section(get_config_path("Lepmon_config.json"), "GPS", "longitude", longitude_write)
